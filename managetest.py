...
engine = sqlalchemy.create_engine('mysql://travis:mysql@127.0.0.1') # connect to server
engine.execute("DROP SCHEMA IF EXISTS HMU_TEST") 
engine.execute("CREATE SCHEMA HMU_TEST") 
engine.execute("USE HMU_TEST")
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://travis:mysql@127.0.0.1/HMU_TEST'
